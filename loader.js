export function showLoader(type, htmlEl, options = {}) {
    ...
    loader.classList.add("pop-loader");
    loader.innerHTML = `<svg class='pop-loader-svg' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export function closeLoader(type = null, htmlEl = null) {
    ...
    //remove all loaders
        ...
        document.querySelectorAll(".pop-loader").forEach(el => el.remove());
    }
}

const loader = { showLoader, closeLoader };
