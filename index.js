...
export function simplePop(type, message, position = "top") {
    ...
    if (type === "warning") type = "pop-warning";
    ...
    else if (type === "pop-warning") {
        alert.innerHTML = `<svg style="margin-right:15px" class="pop-svg" width="90" height="90" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
